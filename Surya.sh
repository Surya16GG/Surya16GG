...
display_welcome() {
  ...
  echo -e "${BLUE}[+]                  © SURYA DEVELOPER              [+]${NC}"
  echo -e "${BLUE}[+]                                                 [+]${NC}"
  echo -e "${RED}[+] =============================================== [+]${NC}"
  echo -e ""
...
check_token() {
  echo -e "                                                       "
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "${BLUE}[+]               PROJECT SURYA DEVELOPER            [+]${NC}"
  echo -e "${BLUE}[+] =============================================== [+]${NC}"
  echo -e "                                                       "
  echo -e "${YELLOW}MASUKAN AKSES TOKEN :${NC}"
  read -r USER_TOKEN

  if [ "$USER_TOKEN" = "SuryaGanteng" ]; then
    echo -e "${GREEN}AKSES BERHASIL${NC}}"
  else
    echo -e "${GREEN}Buy dulu Gih Ke Surya${NC}"
    echo -e "${YELLOW}TELEGRAM : @Sury16GG${NC}"
    echo -e "${YELLOW}WHATSAPP : 6285750909853{NC}"
    echo -e "${YELLOW}HARGA TOKEN : 10K FREE UPDATE JIKA ADA TOKEN BARU${NC}"
    echo -e "${YELLOW}©Surya Developer${NC}"
    exit 1
  fi
  clear
}
  ...
  while true; do
    ...
    case "$SELECT_THEME" in
      ...
      2)
        ...
        ;;
      3)
        THEME_URL=$(echo -e "https://github.com/Surya16GG/Surya16GG/raw/main/C3.zip")
        break
        ;; 
      x)
        return
...
while true; do
  ...
  echo -e "${RED}'ggg      ,gg'''  .    ggg       Auto Installer Surya Developer  ${NC}"
  echo -e "${RED}gggg      gg     ,     ggg      ------------------------  ${NC}"
  echo -e "${RED}ggg:     gg.     -   ,ggg       • Telegram : Sury16GG      ${NC}"
  echo -e "${RED} ggg:     ggg._    _,ggg        • Creadit  : Surya Gantebg ${NC}"
  echo -e "${RED} ggg.    '.'''ggggggp           • Support by Surya Developer ${NC}"
